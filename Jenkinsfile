pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://51.20.44.253:9090/manager/text'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    stages {
        stage('Clone Repository') {
            steps {
                git url: 'https://github.com/2300031420/practical3.git', branch: 'master'
            }
        }
    ...
    post {
        success {
            echo "✅ Backend deployed: http://51.20.44.253:9090/springapp1"
            echo "✅ Frontend deployed: http://51.20.44.2536:9090/frontapp1"
        }
        failure {
